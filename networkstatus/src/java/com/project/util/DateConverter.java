...
public class DateConverter {
    ...
    public static int getMinutefromUnixTIme(long unixTime) {
        DateTime jodaTime = new DateTime(unixTime * 1000L);
...
//    //For DateConversion from local timezone to UTC format to make it input for Search
//    public static String getUTCTimeZoneFromInputDateForElasticSearch(final String fromDateTime) {
//
...
//    }
    //For DateConversion from localunixdate to UTC format to make it input for Search
...
//    public static long getLocalTimeUnixFromUTCTimeZoneElasticSearch(String dateTime) {
//        try {
//            //2015-06-23T16:16:41.000ZHH:mm:ss.SSS
//            //2015-06-23T16:16:41.000Z
//            DateFormat format = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
//            Date d1 = format.parse(dateTime);
//
//            DateTimeZone fromTimeZone = DateTimeZone.forID("UTC");
//            DateTimeZone toTimeZone = DateTimeZone.getDefault();
//
//            final DateTimeFormatter outputFormatter1 = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss");
//            String newPattern = outputFormatter1.print(d1.getTime());
//
////            System.out.println("===Date Before Pattern Changed Only ===" + newPattern);
//            final DateTime dateTimeconvert = new DateTime(newPattern, fromTimeZone);
//
//            final DateTimeFormatter outputFormatter = DateTimeFormat.forPattern("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").withZone(toTimeZone);
//            System.out.println("=== Date Before Pattern Changed Only ===" + outputFormatter.print(dateTimeconvert));
//
//            DateFormat format2 = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
//            Date d2 = format2.parse(outputFormatter.print(dateTimeconvert));
//            long convertedUnixTime = d2.getTime() / 1000;
//
//            return convertedUnixTime;
//        } catch (Exception e) {
//            return 0;
...
//        // Custom date format
    ...
    public static void main(String args[]) {
        System.out.println(getCurrentConvertedDateAndTimeInUnixDate());
