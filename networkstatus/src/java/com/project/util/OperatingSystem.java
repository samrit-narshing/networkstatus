...
//        Double totalRAM = getTotalMemoryRAM();
//        Double freeRAM = getFreeMemoryRAM();
            ...
            for (Method method : operatingSystemMXBean.getClass().getDeclaredMethods()) {
                ...
                if (method.getName().startsWith("get")
                    ...
                    if (method.getName().equalsIgnoreCase("getTotalPhysicalMemorySize")) {
                        totalRAM = (double) (Long.valueOf(value.toString()) / (1024 * 1024));
                    }

                    if (method.getName().equalsIgnoreCase("getFreePhysicalMemorySize")) {
                        freeRAM = (double) (Long.valueOf(value.toString()) / (1024 * 1024));
                    }
            ...
            for (Method method : operatingSystemMXBean.getClass().getDeclaredMethods()) {
                ...
                if (method.getName().startsWith("get")
                    ...
                    if (method.getName().equalsIgnoreCase("getTotalSwapSpaceSize")) {
                        totalSWAPRAM = (double) (Long.valueOf(value.toString()) / (1024 * 1024));
                    }

                    if (method.getName().equalsIgnoreCase("getFreeSwapSpaceSize")) {
                        freeSWAPRAM = (double) (Long.valueOf(value.toString()) / (1024 * 1024));
                    }
                    System.out.println(method.getName() + " = " + value);
                } // if
            } // for
...
//                        System.out.println("Total : " + Double.parseDouble(new RegEx_Tool().capture(regx, str, 1)));
//                        System.out.println("Total UNIT: " + new RegEx_Tool().capture(regx, str, 3));
//
//                        System.out.println("USED : " + Double.parseDouble(new RegEx_Tool().capture(regx, str, 4)));
//                        System.out.println("USED UNIT: " + new RegEx_Tool().capture(regx, str, 6));
//
//                        System.out.println("FREE : " + Double.parseDouble(new RegEx_Tool().capture(regx, str, 7)));
//                        System.out.println("FREE UNIT: " + new RegEx_Tool().capture(regx, str, 9));
...
//        MemoryStatsModel memoryStatsSWAP = systemUtil.getSWAPRAMStatusInMB();
...
//
//        MemoryStatsModel memoryStatsRAM = systemUtil.getPhysicalRAMStatusInMB();
