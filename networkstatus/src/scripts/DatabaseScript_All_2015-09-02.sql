...
--
-- Host: localhost
-- Generation Time: Sep 01, 2015 at 01:34 AM
...
--
-- Table structure for table `SyslogReport`
--

DROP TABLE IF EXISTS `SyslogReport`;
CREATE TABLE IF NOT EXISTS `SyslogReport` (
  ...
  `SrcIP` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `DstIP` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `SrcPort` int(11) unsigned DEFAULT NULL,
  `DstPort` int(11) unsigned DEFAULT NULL,
  ...
  `BSend` bigint(20) unsigned DEFAULT NULL,
  `BRecv` bigint(20) unsigned DEFAULT NULL,
  `Interface` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Options` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RespCode` int(11) unsigned DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `SyslogReport`
--

TRUNCATE TABLE `SyslogReport`;
--
-- Dumping data for table `SyslogReport`
--
--
...
--
-- Indexes for table `SyslogReport`
--
ALTER TABLE `SyslogReport`
 ADD PRIMARY KEY (`ID`,`DeviceReportedTime`), ADD KEY `EventID` (`EventID`);
--
-- Database: `Syslog`
--
DROP DATABASE `Syslog`;
CREATE DATABASE IF NOT EXISTS `Syslog` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `Syslog`;
...
CREATE TABLE IF NOT EXISTS `DailyEvents` (
  `Day` date NOT NULL,
  `TotalEvents` int(10) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `DailyEvents`
--

TRUNCATE TABLE `DailyEvents`;
--
-- Dumping data for table `DailyEvents`
--

INSERT INTO `DailyEvents` (`Day`, `TotalEvents`) VALUES
('2014-10-20', 18);

-- --------------------------------------------------------

--
-- Table structure for table `HourlyEvents`
--

DROP TABLE IF EXISTS `HourlyEvents`;
CREATE TABLE IF NOT EXISTS `HourlyEvents` (
  `Day` date NOT NULL,
  `Hour` int(2) NOT NULL,
  `TotalEvents` int(10) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Truncate table before insert `HourlyEvents`
--

TRUNCATE TABLE `HourlyEvents`;
--
-- Dumping data for table `HourlyEvents`
--

INSERT INTO `HourlyEvents` (`Day`, `Hour`, `TotalEvents`) VALUES
('2012-12-29', 0, 335),
('2014-10-20', 13, 18);
...
--
-- Table structure for table `LcCounter`
--

DROP TABLE IF EXISTS `LcCounter`;
CREATE TABLE IF NOT EXISTS `LcCounter` (
  `id` int(11) NOT NULL,
  `lastdate_str` varchar(50) DEFAULT NULL,
  `lastdate_dbl` double NOT NULL DEFAULT '0',
  `lastid_long` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Truncate table before insert `LcCounter`
--

TRUNCATE TABLE `LcCounter`;
--
-- Dumping data for table `LcCounter`
--

INSERT INTO `LcCounter` (`id`, `lastdate_str`, `lastdate_dbl`, `lastid_long`) VALUES
(1, NULL, 1413786664, 0),
(2, '', 0, 0);
...
--
-- Table structure for table `SecondlyEvents`
--

DROP TABLE IF EXISTS `SecondlyEvents`;
CREATE TABLE IF NOT EXISTS `SecondlyEvents` (
  `Day` datetime NOT NULL,
  `TotalEvents` int(10) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `SecondlyEvents`
--

TRUNCATE TABLE `SecondlyEvents`;
--
-- Dumping data for table `SecondlyEvents`
--

INSERT INTO `SecondlyEvents` (`Day`, `TotalEvents`) VALUES
('2015-09-01 08:34:00', 1),
('2015-09-01 07:47:33', 1);
...
`ID` int(10) unsigned NOT NULL,
  ...
  `Facility` smallint(6) unsigned DEFAULT NULL,
  `Priority` smallint(6) unsigned DEFAULT NULL,
  `FromHost` varchar(60) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Message` text COLLATE utf8_unicode_ci,
  `EventID` int(11) unsigned DEFAULT NULL,
  `InfoUnitID` int(11) unsigned DEFAULT NULL,
  ...
  `Options` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RespCode` int(11) unsigned DEFAULT NULL
) ENGINE=MyISAM AUTO_INCREMENT=15241 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `SystemEvents`
--
...
INSERT INTO `SystemEvents` (`ID`, `ReceivedAt`, `DeviceReportedTime`, `Facility`, `Priority`, `FromHost`, `Message`, `EventID`, `InfoUnitID`, `SysLogTag`, `User`, `MAC`, `Protocol`, `Interface`, `SrcIP`, `DstIP`, `SrcPort`, `DstPort`, `BRecv`, `BSend`, `URL`, `Options`, `RespCode`) VALUES
(1, '2014-10-20 13:30:47', '2014-10-20 13:30:47', 2, 6, 'gldev', ' s9K6UlPW002299: from=root, size=471, class=0, nrcpts=1, msgid=<201410200630.s9K6UlPW002299@gldev.siamsecure.net>, relay=root@localhost', NULL, 1, 'pf:', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15239, '2015-09-01 08:33:00', '2015-09-01 08:33:00', 9, 6, 'gatelogger', ' (root) CMD (^I/usr/local/bin/php /root/SecondlyEvents_update.php >/dev/null 2>&1)', NULL, 1, '/usr/sbin/cron[1688]:', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15240, '2015-09-01 08:34:00', '2015-09-01 08:34:00', 9, 6, 'gatelogger', ' (root) CMD (^I/usr/local/bin/php /root/SecondlyEvents_update.php >/dev/null 2>&1)', NULL, 1, '/usr/sbin/cron[1699]:', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `last_indexed_id`
--

DROP TABLE IF EXISTS `last_indexed_id`;
CREATE TABLE IF NOT EXISTS `last_indexed_id` (
  `ID` int(10) unsigned NOT NULL,
  `last_ID` bigint(20) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Truncate table before insert `last_indexed_id`
--

TRUNCATE TABLE `last_indexed_id`;
--
-- Dumping data for table `last_indexed_id`
--

INSERT INTO `last_indexed_id` (`ID`, `last_ID`) VALUES
(1, 1536);
...
--
-- Indexes for table `DailyEvents`
--
ALTER TABLE `DailyEvents`
 ADD PRIMARY KEY (`Day`);

--
-- Indexes for table `HourlyEvents`
--
ALTER TABLE `HourlyEvents`
 ADD PRIMARY KEY (`Day`,`Hour`);

--
-- Indexes for table `SecondlyEvents`
--
ALTER TABLE `SecondlyEvents`
 ADD PRIMARY KEY (`Day`);
...
ALTER TABLE `SystemEvents`
 ADD PRIMARY KEY (`ID`), ADD KEY `devicetime` (`ReceivedAt`,`DeviceReportedTime`);

--
-- Indexes for table `last_indexed_id`
--
ALTER TABLE `last_indexed_id`
 ADD PRIMARY KEY (`ID`);
...
--
ALTER TABLE `SystemEvents`
MODIFY `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15241;--
-- Database: `gatelogger`
--
DROP DATABASE `gatelogger`;
CREATE DATABASE IF NOT EXISTS `gatelogger` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gatelogger`;
...
CREATE TABLE IF NOT EXISTS `caching` (
  ...
  `proxyport` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `allowedsubnet` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `memcache` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `diskcachedir` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `diskcache` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `maxobjsize` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cacheswaplow` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `cacheswaphigh` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `caching`
--
...
INSERT INTO `caching` (`enabled`, `proxyport`, `allowedsubnet`, `memcache`, `diskcachedir`, `diskcache`, `maxobjsize`, `cacheswaplow`, `cacheswaphigh`) VALUES
(0, '3128', '192.9.200.0/24', '256', '/usr/local/squid/cache', '2048', '4096', '90', '95');
...
CREATE TABLE IF NOT EXISTS `captiveportal` (
  ...
  `radiusserver1` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `radiusserver2` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `radiussecret` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `dhcpif` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `uamserver` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `uamhomepage` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `uamsecret` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `uamlisten` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `captiveportal`
--

TRUNCATE TABLE `captiveportal`;
--
-- Dumping data for table `captiveportal`
--

INSERT INTO `captiveportal` (`net`, `dns1`, `dns2`, `radiusserver1`, `radiusserver2`, `radiussecret`, `dhcpif`, `uamserver`, `uamhomepage`, `uamsecret`, `uamlisten`) VALUES
('192.9.200.0/24', '172.30.1.254', '203.144.207.29', '127.0.0.1', '127.0.0.1', 'testing123', 'rl0', 'https://192.9.200.201/cgi-bin/hotspotlogin.cgi', 'https://192.9.200.201/welcome.html', 'password', '192.9.200.201');

-- --------------------------------------------------------

--
-- Table structure for table `captiveportal2`
--

DROP TABLE IF EXISTS `captiveportal2`;
CREATE TABLE IF NOT EXISTS `captiveportal2` (
  `enabled` tinyint(1) NOT NULL,
  `radiusip` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `radiusport` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `clientsubnet` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `sharedsecret` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `captiveportal2`
--

TRUNCATE TABLE `captiveportal2`;
--
-- Dumping data for table `captiveportal2`
--

INSERT INTO `captiveportal2` (`enabled`, `radiusip`, `radiusport`, `clientsubnet`, `sharedsecret`) VALUES
(0, '127.0.0.1', '1812', '10.0.0.0/8', 'testing123');
...
--
-- Truncate table before insert `chart`
--
...
(1, 'Event Statistics In Last 1 Hour'),
(2, 'Hourly Events'),
(3, 'Top 10 Devices In Last 1 Hour'),
(4, 'Daily Events'),
(5, 'Event Statistics In Last 24 Hour'),
(6, 'Top 10 Devices In Last 24 Hour'),
(7, 'Instant EPS In Last 15 Minutes'),
(8, 'Instant EPS In Last 1 Hour'),
(9, 'Instant Top 10 Devices In Last 1 Hour'),
(10, 'Instant Hourly Events'),
(11, 'Instant EPS In Last 15 Minutes Beta'),
(12, 'Instant EPS In Last 1 Hour Beta'),
(13, 'Instant EPS In Last 1 Hour (Elastic Search)'),
(14, 'Instant Top 10 Devices In Last 1 Hour (Elastic Search)'),
(15, 'Instant Hourly Events (Elastic Search)');
...
--
-- Truncate table before insert `dashboard_chart`
--

TRUNCATE TABLE `dashboard_chart`;
--
-- Dumping data for table `dashboard_chart`
--

INSERT INTO `dashboard_chart` (`user_name`, `chart_id`) VALUES
('sam', '11'),
('sam', '12'),
('sam', '13'),
('sam', '14'),
...
--
-- Truncate table before insert `forward`
--
...
--
-- Table structure for table `ftpupload`
--

DROP TABLE IF EXISTS `ftpupload`;
CREATE TABLE IF NOT EXISTS `ftpupload` (
  `id` int(10) unsigned NOT NULL,
...
--
-- Truncate table before insert `ftpupload`
--

TRUNCATE TABLE `ftpupload`;
--
-- Dumping data for table `ftpupload`
--

INSERT INTO `ftpupload` (`id`, `address`, `username`, `password`, `noofdays`, `action`, `status`, `hour`, `minute`) VALUES
(1, '192.168.229.1', 'samrit', 'samrit', 1, 'C', 0, 0, 0);
...
--
-- Truncate table before insert `hosts`
--
...
--
-- Table structure for table `listenerport`
--

DROP TABLE IF EXISTS `listenerport`;
CREATE TABLE IF NOT EXISTS `listenerport` (
  `protocol` varchar(256) COLLATE utf8_unicode_ci NOT NULL,
  `port` varchar(256) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `listenerport`
--

TRUNCATE TABLE `listenerport`;
--
-- Dumping data for table `listenerport`
--

INSERT INTO `listenerport` (`protocol`, `port`) VALUES
('UDP', '514');
...
CREATE TABLE IF NOT EXISTS `ntp` (
  `primary_server` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `secondary_server` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `ntp`
--
...
INSERT INTO `ntp` (`primary_server`, `secondary_server`) VALUES
('time1.nimt.or.th', 'clock.nectec.or.th');

-- --------------------------------------------------------

--
-- Table structure for table `senderip`
--

DROP TABLE IF EXISTS `senderip`;
CREATE TABLE IF NOT EXISTS `senderip` (
`id` int(11) NOT NULL,
...
--
-- Truncate table before insert `senderip`
--

TRUNCATE TABLE `senderip`;
--
-- Dumping data for table `senderip`
--

INSERT INTO `senderip` (`id`, `devicename`, `ip`) VALUES
(3, 'gatelogger', '127.0.0.1');

-- --------------------------------------------------------

--
-- Table structure for table `storedb`
--

DROP TABLE IF EXISTS `storedb`;
CREATE TABLE IF NOT EXISTS `storedb` (
`id` int(11) NOT NULL,
  `filter` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ip` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Truncate table before insert `storedb`
--

TRUNCATE TABLE `storedb`;
--
-- Dumping data for table `storedb`
--

INSERT INTO `storedb` (`id`, `filter`, `ip`, `db`, `user`, `password`, `template`) VALUES
(1, '*.*', '127.0.0.1', 'Syslog', 'triumph', 'hOWsjH/gz5nizwgYeDZlpRRGwHwJeBerfWDsQhRJhkI=', '');
...
--
-- Truncate table before insert `storefile`
--

TRUNCATE TABLE `storefile`;
--
-- Dumping data for table `storefile`
--

INSERT INTO `storefile` (`id`, `filter`, `file`, `template`) VALUES
(4, '*.*', '/var/log/all.log', '');

-- --------------------------------------------------------

--
-- Table structure for table `storefilter`
--

DROP TABLE IF EXISTS `storefilter`;
CREATE TABLE IF NOT EXISTS `storefilter` (
`id` int(11) NOT NULL,
  `host` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `contain` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ip` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `db` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `user` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Truncate table before insert `storefilter`
--

TRUNCATE TABLE `storefilter`;
-- --------------------------------------------------------
...
INSERT INTO `user_device` (`user_name`, `device_id`) VALUES
('sam', 3);
...
('admin', 'ROLE_RADIUS'),
('admin', 'ROLE_USER'),
('GL10fl213', 'ROLE_RADIUS'),
('GL1136csg', 'ROLE_RADIUS'),
('GL12o0qa6', 'ROLE_RADIUS'),
('GL13c8cd5', 'ROLE_RADIUS'),
('GL14kh4iu', 'ROLE_RADIUS'),
('GL1j2t29', 'ROLE_RADIUS'),
('GL3xk5e8', 'ROLE_RADIUS'),
('GL65sj7r', 'ROLE_RADIUS'),
('GL7wzu30', 'ROLE_RADIUS'),
('operator', 'ROLE_USER'),
('root', 'ROLE_ADMINISTRATOR'),
('root', 'ROLE_USER'),
('sam', 'ROLE_ADMINISTRATOR'),
('sam', 'ROLE_RADIUS'),
('sam', 'ROLE_USER');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `enabled` tinyint(1) NOT NULL,
  `rad_pass` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `rad_timeout` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `rad_expiration` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `users` (`user_name`, `user_pass`, `enabled`, `rad_pass`, `rad_timeout`, `rad_expiration`) VALUES
('admin', 'd033e22ae348aeb5660fc2140aec35850c4da997', 1, '21232f297a57a5a743894a0e4a801fc3', '28800', 'Never Expires'),
('sam', 'f16bed56189e249fe4ca8ed10a1ecae60e8ceac0', 1, '332532dcfaa1cbf61e2a266bd723612c', '28800', 'Never Expires'),
('GL3xk5e8', '3bb3f07c35e9606df140a3a178bc4ac094b59368', 0, 'a82c3b8993a803e8ded16078249ba882', '28800', '2013-03-22'),
('GL1136csg', '234c90731938d8d2578ea8492cd8f563417c27b5', 0, '087403af8b00a0a794bcbd615a94dacb', '28800', '2013-03-22'),
('GL1j2t29', '2dc09217c5c3388b7a23f97c70c8848bc51852b1', 1, '427d08068a5ae313f6ebf542794c593f', '28800', 'Never Expires'),
('GL65sj7r', '812af30067cf95f606d840e24234c95635b142f7', 0, 'fc84a808ffd155eae657eedb438eef38', '28800', '2013-03-22'),
('GL7wzu30', 'd207e9479404ed95d59b984043051be8e475f47a', 1, '911c594555b08f82e688b3074ca428c2', '28800', 'Never Expires'),
('GL10fl213', '7e0f2d357c5af2bbaeb8c9afa8db421f75cf55e0', 0, '132bff92b017ca4806af8dcb11b74a13', '28800', '2013-03-22'),
('GL12o0qa6', 'd92141ffc706a4bec3ac9b696d81b2f1fc9a15f5', 1, '275c7a708061c091ff8158356818428f', '28800', 'Never Expires'),
('GL13c8cd5', '10b3df839beb3272299de4039f2020254548d65b', 1, '22d21755f04e20503ebaf32ea15a4fba', '28800', 'Never Expires'),
('GL14kh4iu', '64c7f89ce5edf69bde782cef7841a90a673e0eca', 0, '7962a984fcc87470afdac8dcd984047f', '28800', '2013-03-22'),
('operator', 'fe96dd39756ac41b74283a9292652d366d73931f', 1, '4b583376b2767b923c3e1da60d10de59', '28800', '2014-10-20'),
('root', 'dc76e9f0c0006e8f919e0c515c66dbba3982f785', 1, '63a9f0ea7bb98050796b649e85481845', '28800', '2014-10-20');
...
`id` int(10) unsigned NOT NULL,
  ...
  `identityno` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `dateofbirth` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `address` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `phoneno` varchar(45) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `dateofregister` varchar(80) COLLATE utf8_unicode_ci NOT NULL,
  `address2` varchar(200) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `users_public`
--

TRUNCATE TABLE `users_public`;
--
-- Dumping data for table `users_public`
--

INSERT INTO `users_public` (`id`, `user_name`, `first_name`, `last_name`, `identityno`, `dateofbirth`, `address`, `phoneno`, `email`, `dateofregister`, `address2`) VALUES
(2, 'GL1j2t29', 'public', 'public', 'public', '2013-03-22', 'public', '', '', '2013-03-22', ''),
(5, 'GL3xk5e8', 'g', 'g', 'g', '2013-03-22', 'g', '', '', '2013-03-22', ''),
(6, 'GL65sj7r', 'a', 's', 's', '2013-03-22', 's', '', '', '2013-03-22', ''),
(9, 'GL7wzu30', 'pub12', 'pub12', 'pub12', '2013-03-22', 'pub12', '', '', '2013-03-22', ''),
(10, 'GL10fl213', 'pub122', 'pub122', 'pub122', '2013-03-22', 'pub122', '', '', '2013-03-22', ''),
(11, 'GL1136csg', 'pub3', 'pub3', 'pub3', '2013-03-22', 'pub122', '', '', '2013-03-22', ''),
(12, 'GL12o0qa6', 'pub4', 'pub4', 'pub4', '2013-03-22', 'pub4', '', '', '2013-03-22', ''),
(13, 'GL13c8cd5', 'pub5', 'pub5', 'pub5', '2013-03-22', 'pub5', '', '', '2013-03-22', ''),
(14, 'GL14kh4iu', 'fff', 'fff', 'fff', '2013-03-22', 'fff', '', '', '2013-03-22', '');
...
--
-- Indexes for table `captiveportal`
--
ALTER TABLE `captiveportal`
 ADD PRIMARY KEY (`dhcpif`);
...
--
-- Indexes for table `listenerport`
--
ALTER TABLE `listenerport`
 ADD PRIMARY KEY (`protocol`);

--
-- Indexes for table `senderip`
--
ALTER TABLE `senderip`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `storedb`
--
ALTER TABLE `storedb`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `storefile`
--
ALTER TABLE `storefile`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `storefilter`
--
ALTER TABLE `storefilter`
 ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `senderip`
--
ALTER TABLE `senderip`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `storedb`
--
ALTER TABLE `storedb`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `storefile`
--
ALTER TABLE `storefile`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `storefilter`
--
ALTER TABLE `storefilter`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
-- Database: `gatelogger_serial`
--
DROP DATABASE `gatelogger_serial`;
CREATE DATABASE IF NOT EXISTS `gatelogger_serial` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gatelogger_serial`;
...
`id` int(11) NOT NULL,
  `serial` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `serial_md5` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `expire` datetime DEFAULT NULL,
  `is_longterm` tinyint(1) DEFAULT NULL,
  `note` text COLLATE utf8_unicode_ci
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `serial`
--
...
`id` int(8) unsigned NOT NULL,
  ...
  `planName` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `billAmount` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `billAction` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `billPerformer` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `billReason` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `paymentmethod` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `cash` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creditcardname` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creditcardnumber` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creditcardverification` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creditcardtype` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creditcardexp` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `coupon` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Truncate table before insert `billing_history`
--
...
`id` int(8) NOT NULL,
  ...
  `pin` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `txnId` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planName` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planId` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `quantity` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `receiver_email` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `business` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tax` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mc_gross` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mc_fee` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mc_currency` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `address_country` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_country_code` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_city` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_state` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address_zip` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payment_date` datetime DEFAULT NULL,
  `payment_status` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payment_address_status` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `payer_status` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `billing_paypal`
--

TRUNCATE TABLE `billing_paypal`;
-- --------------------------------------------------------
...
`id` int(8) NOT NULL,
  `planName` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planId` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planType` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTimeBank` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTimeType` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTimeRefillCost` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planBandwidthUp` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planBandwidthDown` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTrafficTotal` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTrafficUp` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTrafficDown` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTrafficRefillCost` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planRecurring` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planRecurringPeriod` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planCost` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planSetupCost` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planTax` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planCurrency` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planGroup` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creationdate` datetime DEFAULT '0000-00-00 00:00:00',
  `creationby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updatedate` datetime DEFAULT '0000-00-00 00:00:00',
  `updateby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
...
`id` int(11) unsigned NOT NULL,
  `rateName` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `rateType` varchar(128) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
...
--
-- Truncate table before insert `billing_rates`
--

TRUNCATE TABLE `billing_rates`;
-- --------------------------------------------------------
...
`id` int(10) NOT NULL,
  ...
  `Attribute` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Value` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Format` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `Vendor` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RecommendedOP` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RecommendedTable` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RecommendedHelper` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `RecommendedTooltip` varchar(512) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=MyISAM AUTO_INCREMENT=9417 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Truncate table before insert `dictionary`
--
...
(100, 'ipaddr', 'Framed-IP-Address', NULL, NULL, 'dictionary.rfc2865', NULL, NULL, NULL, NULL),
...
`id` bigint(20) NOT NULL,
  ...
  `mac` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `geocode` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `owner` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email_owner` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `manager` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email_manager` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `companywebsite` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `companyemail` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `companycontact` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `companyphone` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creationdate` datetime DEFAULT '0000-00-00 00:00:00',
  `creationby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updatedate` datetime DEFAULT '0000-00-00 00:00:00',
  `updateby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
...
--
-- Truncate table before insert `hotspots`
--
...
`id` int(11) NOT NULL,
  `username` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `password` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_search` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_batch` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_new_quick` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_list_all` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_hs_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_hs_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_hs_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_hs_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_nas_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_nas_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_nas_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_nas_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_usergroup_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_usergroup_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_usergroup_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_usergroup_list_user` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_usergroup_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupcheck_search` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupcheck_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupcheck_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupcheck_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupcheck_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupreply_search` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupreply_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupreply_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupreply_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_groupreply_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_profiles_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_profiles_duplicate` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_profiles_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_profiles_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_profiles_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_online` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_topusers` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_username` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_lastconnect` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_logs_radius` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_stat_services` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_stat_server` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_logs_system` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_logs_boot` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_logs_daloradius` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_active` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_username` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_all` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_date` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_ipaddress` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_nasipaddress` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_hotspot_accounting` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_hotspot_compare` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_custom_query` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_rates_date` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_rates_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_rates_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_rates_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_rates_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_pos_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_pos_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_pos_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_pos_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_paypal_transactions` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_plans_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_plans_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_plans_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_plans_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bill_history_query` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `gis_editmap` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `gis_viewmap` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `graphs_alltime_logins` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `graphs_alltime_traffic_compare` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `graphs_overall_download` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `graphs_overall_upload` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `graphs_overall_logins` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_db` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_interface` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_lang` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_logging` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_maint_test_user` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_maint_disconnect_user` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_operators_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_operators_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_operators_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_operators_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_backup_createbackups` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `config_backup_managebackups` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `phone1` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone2` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email1` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `email2` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `messenger1` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `messenger2` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `notes` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastlogin` datetime DEFAULT '0000-00-00 00:00:00',
  `creationdate` datetime DEFAULT '0000-00-00 00:00:00',
  `mng_rad_attributes_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_attributes_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_attributes_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_attributes_search` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_attributes_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_attributes_import` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_realms_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_realms_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_realms_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_realms_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_proxys_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_proxys_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_proxys_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_proxys_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_maintenance_cleanup` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `acct_maintenance_delete` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_ippool_list` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_ippool_new` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_ippool_edit` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mng_rad_ippool_del` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `rep_history` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creationby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updatedate` datetime DEFAULT '0000-00-00 00:00:00',
  `updateby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
...
--
-- Truncate table before insert `operators`
--
...
INSERT INTO `operators` (`id`, `username`, `password`, `mng_search`, `mng_batch`, `mng_del`, `mng_edit`, `mng_new`, `mng_new_quick`, `mng_list_all`, `mng_hs_del`, `mng_hs_edit`, `mng_hs_new`, `mng_hs_list`, `mng_rad_nas_del`, `mng_rad_nas_edit`, `mng_rad_nas_new`, `mng_rad_nas_list`, `mng_rad_usergroup_del`, `mng_rad_usergroup_edit`, `mng_rad_usergroup_new`, `mng_rad_usergroup_list_user`, `mng_rad_usergroup_list`, `mng_rad_groupcheck_search`, `mng_rad_groupcheck_del`, `mng_rad_groupcheck_list`, `mng_rad_groupcheck_new`, `mng_rad_groupcheck_edit`, `mng_rad_groupreply_search`, `mng_rad_groupreply_del`, `mng_rad_groupreply_list`, `mng_rad_groupreply_new`, `mng_rad_groupreply_edit`, `mng_rad_profiles_edit`, `mng_rad_profiles_duplicate`, `mng_rad_profiles_del`, `mng_rad_profiles_list`, `mng_rad_profiles_new`, `rep_online`, `rep_topusers`, `rep_username`, `rep_lastconnect`, `rep_logs_radius`, `rep_stat_services`, `rep_stat_server`, `rep_logs_system`, `rep_logs_boot`, `rep_logs_daloradius`, `acct_active`, `acct_username`, `acct_all`, `acct_date`, `acct_ipaddress`, `acct_nasipaddress`, `acct_hotspot_accounting`, `acct_hotspot_compare`, `acct_custom_query`, `bill_rates_date`, `bill_rates_del`, `bill_rates_new`, `bill_rates_edit`, `bill_rates_list`, `bill_pos_del`, `bill_pos_new`, `bill_pos_edit`, `bill_pos_list`, `bill_paypal_transactions`, `bill_plans_del`, `bill_plans_new`, `bill_plans_edit`, `bill_plans_list`, `bill_history_query`, `gis_editmap`, `gis_viewmap`, `graphs_alltime_logins`, `graphs_alltime_traffic_compare`, `graphs_overall_download`, `graphs_overall_upload`, `graphs_overall_logins`, `config_db`, `config_interface`, `config_lang`, `config_logging`, `config_maint_test_user`, `config_maint_disconnect_user`, `config_operators_del`, `config_operators_edit`, `config_operators_list`, `config_operators_new`, `config_backup_createbackups`, `config_backup_managebackups`, `firstname`, `lastname`, `title`, `department`, `company`, `phone1`, `phone2`, `email1`, `email2`, `messenger1`, `messenger2`, `notes`, `lastlogin`, `creationdate`, `mng_rad_attributes_list`, `mng_rad_attributes_new`, `mng_rad_attributes_edit`, `mng_rad_attributes_search`, `mng_rad_attributes_del`, `mng_rad_attributes_import`, `mng_rad_realms_list`, `mng_rad_realms_new`, `mng_rad_realms_edit`, `mng_rad_realms_del`, `mng_rad_proxys_list`, `mng_rad_proxys_new`, `mng_rad_proxys_edit`, `mng_rad_proxys_del`, `acct_maintenance_cleanup`, `acct_maintenance_delete`, `mng_rad_ippool_list`, `mng_rad_ippool_new`, `mng_rad_ippool_edit`, `mng_rad_ippool_del`, `rep_history`, `creationby`, `updatedate`, `updateby`) VALUES
(1, 'administrator', 'radius', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'Sys', 'Administrator', '', '', '', '', '', '', '', '', '', '', '2009-11-20 16:17:49', '0000-00-00 00:00:00', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', NULL, '0000-00-00 00:00:00', NULL),
(2, 'liran', '1234', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'Liran', 'Tal', 'Developer', 'daloRADIUS', 'Enginx', '', '', 'liran.tal@gmail.com', 'liran@enginx.com', '', '', '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', NULL);
...
`id` bigint(20) NOT NULL,
  `proxyname` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Truncate table before insert `proxys`
--

TRUNCATE TABLE `proxys`;
-- --------------------------------------------------------
...
(65, 'admin', 'MD5-Password', ':=', '21232f297a57a5a743894a0e4a801fc3'),
(2, 'sam', 'MD5-Password', ':=', '332532dcfaa1cbf61e2a266bd723612c'),
(16, 'GL1j2t29', 'MD5-Password', ':=', '427d08068a5ae313f6ebf542794c593f'),
(17, 'GL38lidm', 'MD5-Password', ':=', 'fa4b0e57487ab6f91a64524e227a7bbd'),
(18, 'GL38lidm', 'Expiration', ':=', '22 Mar 2013'),
(25, 'GL3xk5e8', 'MD5-Password', ':=', 'a82c3b8993a803e8ded16078249ba882'),
(26, 'GL3xk5e8', 'Expiration', ':=', '22 Mar 2013'),
(41, 'GL7wzu30', 'MD5-Password', ':=', '911c594555b08f82e688b3074ca428c2'),
(42, 'GL10fl213', 'MD5-Password', ':=', '132bff92b017ca4806af8dcb11b74a13'),
(43, 'GL10fl213', 'Expiration', ':=', '22 Mar 2013'),
(51, 'GL1136csg', 'MD5-Password', ':=', '087403af8b00a0a794bcbd615a94dacb'),
(52, 'GL1136csg', 'Expiration', ':=', '22 Mar 2013'),
(53, 'GL12o0qa6', 'MD5-Password', ':=', '275c7a708061c091ff8158356818428f'),
(54, 'GL13c8cd5', 'MD5-Password', ':=', '22d21755f04e20503ebaf32ea15a4fba'),
(57, 'GL14kh4iu', 'MD5-Password', ':=', '7962a984fcc87470afdac8dcd984047f'),
(58, 'GL14kh4iu', 'Expiration', ':=', '22 Mar 2013');
...
--
-- Truncate table before insert `radippool`
--

TRUNCATE TABLE `radippool`;
--
...
(1, 'admin', 'GLW3b@pp', 'Access-Accept', '2012-12-13 00:43:28');
...
(41, 'admin', 'Session-Timeout', ':=', '28800'),
(2, 'sam', 'Session-Timeout', ':=', '28800'),
(13, 'GL1j2t29', 'Session-Timeout', ':=', '28800'),
(14, 'GL38lidm', 'Session-Timeout', ':=', '28800'),
(18, 'GL3xk5e8', 'Session-Timeout', ':=', '28800'),
(26, 'GL7wzu30', 'Session-Timeout', ':=', '28800'),
(27, 'GL10fl213', 'Session-Timeout', ':=', '28800'),
(32, 'GL1136csg', 'Session-Timeout', ':=', '28800'),
(33, 'GL12o0qa6', 'Session-Timeout', ':=', '28800'),
(34, 'GL13c8cd5', 'Session-Timeout', ':=', '28800'),
(36, 'GL14kh4iu', 'Session-Timeout', ':=', '28800');
...
`id` bigint(20) NOT NULL,
  `realmname` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `type` varchar(32) COLLATE utf8_unicode_ci DEFAULT NULL,
  `authhost` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL,
  `accthost` varchar(256) COLLATE utf8_unicode_ci DEFAULT NULL,
  `secret` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ldflag` varchar(64) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Truncate table before insert `realms`
--
...
`id` int(8) unsigned NOT NULL,
  `username` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `planName` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `contactperson` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `company` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `creditcardexp` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `notes` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `changeuserbillinfo` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lead` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `coupon` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ordertaker` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `billstatus` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL,
  `lastbill` datetime DEFAULT '0000-00-00 00:00:00',
  `nextbill` datetime DEFAULT '0000-00-00 00:00:00',
  `postalinvoice` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `faxinvoice` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `emailinvoice` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `creationdate` datetime DEFAULT '0000-00-00 00:00:00',
  `creationby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL,
  `updatedate` datetime DEFAULT '0000-00-00 00:00:00',
  `updateby` varchar(128) COLLATE utf8_unicode_ci DEFAULT NULL
...
--
-- Truncate table before insert `userbillinfo`
--

TRUNCATE TABLE `userbillinfo`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `wimax`
--

TRUNCATE TABLE `wimax`;
--
-- Indexes for dumped tables
--
...
ALTER TABLE `billing_plans`
 ADD PRIMARY KEY (`id`), ADD KEY `planName` (`planName`);

--
-- Indexes for table `billing_rates`
--
ALTER TABLE `billing_rates`
 ADD PRIMARY KEY (`id`), ADD KEY `rateName` (`rateName`);
...
--
ALTER TABLE `nas`
 ADD PRIMARY KEY (`id`), ADD KEY `nasname` (`nasname`);
...
--
ALTER TABLE `radacct`
 ADD PRIMARY KEY (`radacctid`), ADD KEY `username` (`username`), ADD KEY `framedipaddress` (`framedipaddress`), ADD KEY `acctsessionid` (`acctsessionid`), ADD KEY `acctsessiontime` (`acctsessiontime`), ADD KEY `acctuniqueid` (`acctuniqueid`), ADD KEY `acctstarttime` (`acctstarttime`), ADD KEY `acctstoptime` (`acctstoptime`), ADD KEY `nasipaddress` (`nasipaddress`);
...
--
ALTER TABLE `wimax`
 ADD PRIMARY KEY (`id`), ADD KEY `username` (`username`), ADD KEY `spi` (`spi`);
...
--
ALTER TABLE `dictionary`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9417;
--
