    ...
    <body class="noheader" onload='document.loginForm.username.focus();'>
        ...
        <div id="body">
            <div id="breadcrumbs">
                ...
                <strong>Upload File Size Exceeded</strong>
            </div>
                            ...
                            <ul>
                                <li>
                                    <p style="margin: 0;">
                                        ...
                                        <br/>
                                        <h1>HTTP Status 500 - Upload File Size Exceeded</h1>
                                        <br/>
                                        <c:choose>
                                            <c:when test="${empty username}">
                                                <h5>The File Size Is Too Big To Upload!</h5>
                                            </c:when>
                                            <c:otherwise>
                                                <h5>UserName : ${username} <br/> The File Size Is Too Big To Upload!</h5>
                                            </c:otherwise>
                                        </c:choose>
