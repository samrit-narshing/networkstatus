    ...
    <body class="noheader">
        ...
        <div id="body">
            <div id="breadcrumbs">
                ...
                <strong>List Application Log Messages</strong>
            </div>
            <div id="content">
                <!--Div Content Start-->
                ...
                <fieldset>
                    <legend>Search Application Log Messages</legend>

                    <form name="form1" method="post" action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/search/submit">
                ...
                <form name="form1" method="post" action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/delete/all/submit">
                    <input type="hidden" name="${_csrf.parameterName}"
                           value="${_csrf.token}" />

                    <p><input name="send" class="formbutton" value="Delete All Log Message" type="submit" style="width: 100%"  onclick="return confirmContiune();" /></p>

                </form>


                <form name="form1" method="post" action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/dummyexecption/submit">
                    <input type="hidden" name="${_csrf.parameterName}"
                           value="${_csrf.token}" />

                    <p><input name="send" class="formbutton" value="Send Dummy Exception" type="submit" style="width: 100%"  onclick="return confirmContiune();" /></p>
                        ...
                        <c:forEach items="${applicationLogMessageListResource.applicationLogMessageResources}"
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <form action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/delete/submit" method="post" id="deleteFormId_${application_log_message.tableId}">
                                        <input type="hidden" name="${_csrf.parameterName}"
                                               value="${_csrf.token}" />
                ...
                <div id="pagination" style="text-align: center;width: 100%" >
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/search/submit" method="post" id="paginationPreviousForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/search/submit" method="post" id="paginationNextForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                        <input name="name" type="hidden" value="${searchCriteria.searchText}"/>
                        <input name="pageNo" type="hidden" value="${searchCriteria.pageNo+1}"/>
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/search/submit" method="post" id="paginationFirstForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                        <input name="name" type="hidden" value="${searchCriteria.searchText}"/>
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/applicationlogman/applicationlog/search/submit" method="post" id="paginationLastForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
