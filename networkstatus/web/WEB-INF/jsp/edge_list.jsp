        ...
        <div id="body">
            ...
            <div id="content">
                ...
                <script type="text/javascript">
                    ...
                    {
                        var agree = confirm("Warning!! If you are disabling it then ,all classes related to this edge will also be disabled automatically!\nAre you sure you want to change Status?");
                ...
                <fieldset>
                    <legend>Search Edges</legend>

                    <form name="form1" method="post" action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/search">
                ...
                <table width="100%">
                    <tbody>
                        ...
                        <c:forEach items="${edgeListResource.edgeResources}"
                                   var="edge"
                                   varStatus="status"
                                   begin="0"
                                   end="1999"
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    ...
                                    <c:out value="${edge.fromNodeResource.label}" />
                                ...
                                <td align="center">
                                    ...
                                    <c:out value="${edge.toNodeResource.label}" />

                                    <br>
                                </td>

                                <td align="center">${edge.label}</td>
                                ...
                                <td align="center">
                                    ...
                                    &nbsp;
                                    <a href="javascript:formSubmitById('editFormId_${edge.edgeID}')" title="Edit Edge"> 
                                        <img src="${initParam.PROJECT_ROOT_PATH}/resources/icons/edit_32x32.png" alt="Checked" border="0" width="20" height="20" />
                                    </a>

                                    &nbsp;

                                    <a href="javascript:formSubmitById('updateEnabledFormId_${edge.edgeID}')" onclick="return confirmChangeStatus();"  title="Change Status Of Edge">

                                        <c:choose>
                                            <c:when test="${edge.enabled}">
                                    ...
                                    &nbsp;
                                    <a href="javascript:formSubmitById('deleteFormId_${edge.edgeID}')" onclick="return messageforadmin('${edge.edgeID}');"  title="Delete Edge">
                                        <img src="${initParam.PROJECT_ROOT_PATH}/resources/icons/trash_32x32.png" alt="Checked" border="0" width="20" height="20" />
                                    </a>
                                    &nbsp;

                                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/changeenablestatus/submit" method="post" id="updateEnabledFormId_${edge.edgeID}">
                                        <input type="hidden" name="${_csrf.parameterName}"
                                               value="${_csrf.token}" />
                                    ...
                                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/edit" method="post" id="editFormId_${edge.edgeID}">
                                        <input type="hidden" name="${_csrf.parameterName}"
                                               value="${_csrf.token}" />
                                        <input type="hidden" name="id"
                                               value="${edge.edgeID}" />
                                    ...
                                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/delete/submit" method="post" id="deleteFormId_${edge.edgeID}">
                                        <input type="hidden" name="${_csrf.parameterName}"
                                               value="${_csrf.token}" />
                                        <input type="hidden" name="id"
                                               value="${edge.edgeID}" />
                ...
                <div id="pagination" style="text-align: center;width: 100%" >
                    ...
                    <c:if test="${searchCriteria.pageNo+1<=edgeListResource.totalPages}">
                    ...
                    <c:if test="${searchCriteria.pageNo+2<=edgeListResource.totalPages}">
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/search" method="post" id="paginationPreviousForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/search" method="post" id="paginationNextForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                        <input name="name" type="hidden" value="${searchCriteria.searchText}"/>
                        <input name="pageNo" type="hidden" value="${searchCriteria.pageNo+1}"/>
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/search" method="post" id="paginationFirstForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                        <input name="name" type="hidden" value="${searchCriteria.searchText}"/>
                    ...
                    <form action="${initParam.PROJECT_ROOT_PATH}/edgeman/edge/search" method="post" id="paginationLastForm">
                        <input type="hidden" name="${_csrf.parameterName}"
                               value="${_csrf.token}" />
                        <input name="searchText" type="hidden" value="${searchCriteria.searchText}"/>
                        <input name="pageNo" type="hidden" value="${edgeListResource.totalPages}"/>
                    </form>
