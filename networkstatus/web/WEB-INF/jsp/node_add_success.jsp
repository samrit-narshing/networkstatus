        ...
        <div id="body">
            ...
            <div id="content">
                ...
                <div class="centerbar">
                    <ul>	
                        <li>
                            <h4 class="h4-green"><span>Node Data Entry Status</span></h4>
                            <ul>
                                <li>
                                    <p style="margin: 0;">
                                        ...
                                        <h1>Node Added Successfully.</h1>

                                        <br/>
                                        <h5>Status : Success</h5>

                                        <h5>
                                            Name : ${nodeResource.label}
                                        </h5>
                                        <h5>
                                        ...
                                        <p>
                                            <h3><a href="${initParam.PROJECT_ROOT_PATH}/nodeman/node/add"> Add New Node</a>
                                                <!--&nbsp; &nbsp; &nbsp;-->
